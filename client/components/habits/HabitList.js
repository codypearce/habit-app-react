  ...
  _renderHabits() {
    return (
      this.props.habits.map(habit => {
        return <Habit key={habit.name} habit={habit} editHabit={this.props.editHabit} deleteHabit={this.props.deleteHabit} changeHabitState={this.props.changeHabitState}/>
      })
    )
  }
  render() {
